...
var child = exec('curl -k -X POST "https://electroniccity.rbccps.org:8443/api/1.0.0/share" -H \'apikey: 2yV42DThBljdyrm4d6qUHUmglooWyrIB\' -d \'{"entityID": "intel", "permission":"read", "validity":"100D", "requestorID":"testapp1", "email": "rajaraman.vasanth@gmail.com"}\''
,
    (error, stdout, stderr) => {
