...
const elcita_follow_url = 'https://electroniccity.rbccps.org:8443/api/1.0.0/follow'
...
var child = exec('curl -ik -XPOST "https://electroniccity.rbccps.org:8443/api/1.0.0/follow" -H \'apikey: 6UugLVBMIdechjaQPNlDUb7WxMzPrzvf\' -d \'{ "entityID": "' + query.e + '", "permission":"' + query.p + '", "validity": "' +query.v + '", "requestorID":"' + query.r + '", "email":"' + query.email + '", "contact":"' + query.c + '" }\'',
    (error, stdout, stderr) => {
